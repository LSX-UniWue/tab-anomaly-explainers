...
class STPM(pl.LightningModule):
    ...
    def forward(self, x, keep_grad=True, add_output_dim=True, flip_channels=False, device='cuda',
        ...
        with (torch.no_grad() if not keep_grad else contextlib.nullcontext()):
            ...
            # Get anomaly map
            # TODO: cal_anomaly_map doesnt work for batched inputs!
            ...
            # scores = anomaly_map.amax(dim=(1, 2))  # anomaly score prediction
    ...
    def test_step(self, batch, batch_idx):
        ...
        # TODO: self.pred_list_px_lvl.extend(anomaly_map.flatten(start_dim=1))
